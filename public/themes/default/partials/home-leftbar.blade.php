<div class="widget-events widget-left-panel">
	<div class="menu-list">
		<ul class="list-unstyled">
			...
			<li><a href="{{ url(Auth::user()->username.'/pages-groups') }}" class="btn menu-btn"><i class="fa fa-file-text" aria-hidden="true"></i>{{ trans('common.pages') }} <span class="event-circle pull-right">{{ Auth::user()->own_pages()->count() }}</span></a></li>

			<li><a href="{{ url(Auth::user()->username.'/pages-groups') }}" class="btn menu-btn"><i class="fa fa-group" aria-hidden="true"></i>{{ trans('common.groups') }} <span class="event-circle pull-right">{{ Auth::user()->own_groups()->count() }}</span></a></li>
